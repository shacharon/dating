...
Load [dating-e2e-verification](../dating-e2e-verification/SKILL.md) when the story touches eligibility, preference dimensions, or ranking — extend `me-matches-eligibility.spec-support.ts`, don't hand-roll a new harness.
