...
import type { IMatchNarrativeCacheRepository } from './match-narrative-cache.repository';

@Injectable()
export class PrismaMatchNarrativeCacheRepository
  implements IMatchNarrativeCacheRepository
{
