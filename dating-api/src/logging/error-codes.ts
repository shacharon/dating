...
export const ErrorCodes = {
  ...
  /** Sprint 43 Story 2 — HIGH browse-match email. */
  EMAIL_HIGH_PRIORITY_MATCH_SEND_OK: 'EMAIL_HIGH_PRIORITY_MATCH_SEND_OK',
  EMAIL_HIGH_PRIORITY_MATCH_SEND_FAILED: 'EMAIL_HIGH_PRIORITY_MATCH_SEND_FAILED',
  EMAIL_HIGH_PRIORITY_MATCH_SKIPPED_PREFS: 'EMAIL_HIGH_PRIORITY_MATCH_SKIPPED_PREFS',
  EMAIL_HIGH_PRIORITY_MATCH_SKIPPED_FREQUENCY:
    'EMAIL_HIGH_PRIORITY_MATCH_SKIPPED_FREQUENCY',
  ...
  ADMIN_BETA_METRICS_FETCHED: 'ADMIN_BETA_METRICS_FETCHED',
