 ...
 */
export const holyGrailStructuredPreferencesPatchBodySchema = z.record(
  z.string(),
  z.unknown(),
);

export type HolyGrailStructuredPreferencesPatchBody = z.infer<
  typeof holyGrailStructuredPreferencesPatchBodySchema
>;

export function parseHolyGrailStructuredPreferencesPatchBody(
  body: unknown,
): HolyGrailStructuredPreferencesPatchBody {
