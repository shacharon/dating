...
import {
  ...
  sharedInterestTags,
} from '../policies/interest-alignment';
import {
...
import { buildFinalResultDto } from '../compare/compare-stages/assemble-result';
import { computeCompatibilityAndNuancePenalties } from '../compare/compare-stages/compatibility-nuance';
import { computeCoverageAsymmetryLowEvidenceAdjustments } from '../compare/compare-stages/coverage-asymmetry-friction';
import { computeDealbreakersAndBalance } from '../compare/compare-stages/dealbreakers-balance';
import { deriveProfileContextsAndEnrichedSignals } from '../compare/compare-stages/derive-contexts';
import { computeDirectionalCompatibility } from '../compare/compare-stages/directional-compatibility';
import { computeRelationshipFitAndValuesAlignment } from '../compare/compare-stages/relationship-fit-values';
import { clampTo100 } from '../compare/compare-stages/util';
import type {
