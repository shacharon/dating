...
**Status:** Done · **Depends on:** 51 helpful · **Round:** 2  
...
| 03 | [Guardrails / no-new-regex policy](./STORY_03_no_new_regex_policy.md) | **Done** |

**Order:** 01 → 02 → 03.

**Preferred merge tip:** `feature/sprint-52-story-3`
