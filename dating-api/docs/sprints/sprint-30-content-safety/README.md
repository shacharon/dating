...
**Status:** 🟡 **IN PROGRESS** — Stories 00–02 Done; Story 03 Agent 1 complete → run Agent 2  
...
| 03 | [Message moderation gate](./STORY_03_message_gate.md) | P0 | 1d | Agent 1 done → run Agent 2 |
