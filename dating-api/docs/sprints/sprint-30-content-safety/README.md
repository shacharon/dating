...
**Status:** 🟡 **IN PROGRESS** — Story 00 Done; next Story 01 Agent 0  
...
| 01 | [OpenAI moderation client + violation storage](./STORY_01_moderation_client.md) | P0 | 0.5d | PLANNED → run Agent 0 |
