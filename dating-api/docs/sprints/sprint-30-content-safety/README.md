...
**Status:** 🟡 **IN PROGRESS** — Stories 00–03 Done; Story 04 Agent 0 complete → run Agent 1  
...
- Violation storage + gates live; enforcement consolidate + admin UI still open (Stories 04–05)
...
| 04 | [Violation counting + progressive blocks](./STORY_04_violation_enforcement.md) | P0 | 0.5d | Agent 0 done → run Agent 1 |
