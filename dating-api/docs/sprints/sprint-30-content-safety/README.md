...
**Status:** 🟡 **IN PROGRESS** — Story 00 Done; Story 01 Agent 2 CR PASS → run Agent 3  
...
| 01 | [OpenAI moderation client + violation storage](./STORY_01_moderation_client.md) | P0 | 0.5d | Agent 2 CR PASS → run Agent 3 |
