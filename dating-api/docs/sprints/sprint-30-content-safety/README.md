...
**Status:** 🟡 **IN PROGRESS** — Stories 00–01 Done; Story 02 Agent 1 complete → run Agent 2  
...
| 02 | [Profile field moderation gate](./STORY_02_profile_field_gate.md) | P0 | 1d | Agent 1 done → run Agent 2 |
