...
**Status:** 🟡 **IN PROGRESS** — Story 00 Done; Story 01 Agent 1 complete → run Agent 2  
...
| 01 | [OpenAI moderation client + violation storage](./STORY_01_moderation_client.md) | P0 | 0.5d | Agent 1 done → run Agent 2 |
