...
**Status:** 🟡 **IN PROGRESS** — Stories 00–01 Done; Story 02 Agent 0 complete → run Agent 1  
...
| 02 | [Profile field moderation gate](./STORY_02_profile_field_gate.md) | P0 | 1d | Agent 0 done → run Agent 1 |
