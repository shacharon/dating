...
**Status:** 🟡 **IN PROGRESS** — Stories 00–02 Done; Story 03 Agent 2 CR PASS → run Agent 3  
...
| 03 | [Message moderation gate](./STORY_03_message_gate.md) | P0 | 1d | Agent 2 CR PASS → run Agent 3 |
