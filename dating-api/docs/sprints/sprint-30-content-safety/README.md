...
**Status:** 🟡 **IN PROGRESS** — Stories 00–03 Done; Story 04 Agent 1 complete → run Agent 2  
...
| 04 | [Violation counting + progressive blocks](./STORY_04_violation_enforcement.md) | P0 | 0.5d | Agent 1 done → run Agent 2 |
