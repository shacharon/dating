...
**Status:** In Progress (2/3 stories)  
...
| 02 | [Deprecate/quarantine legacy matches.service](./STORY_02_legacy_matches_cleanup.md) | 2 days | ⚡ LOW–MED | **Done** |
...
- [x] Legacy `matches.service` quarantined under `admin-legacy/` with `@deprecated` markers *(Story 02, `ce6bb00`)*
...
- [x] Story 02 specs green (51 passed on legacy/admin wiring suite)
...
- Product stack clearly separated from admin legacy (`admin-legacy/README.md`)
