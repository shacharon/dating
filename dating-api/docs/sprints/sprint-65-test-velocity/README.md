...
**Status:** Done (Stories 01–03 on feature branches)  
...
| 02 | [Split match-engine.spec](./STORY_02_split_match_engine_spec.md) | 2 days | ⚡ LOW | Done (`feature/sprint-65-story-2`) |
| 03 | [Thin matches HTTP spec](./STORY_03_thin_remaining_specs.md) | 1–2 days | ⚡ LOW | Done (`feature/sprint-65-story-3`) |

**Order:** 01 → 02 → 03.

**Merge branches:** `feature/sprint-65-story-1`, `feature/sprint-65-story-2`, `feature/sprint-65-story-3`.
