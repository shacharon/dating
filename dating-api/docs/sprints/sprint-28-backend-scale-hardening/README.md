...
**Status:** 🟡 **IN PROGRESS** — Story 1 Done; Story 2 Agent 0 done → run Agent 1  
...
| 02 | [Lock expensive endpoints](./STORY_02_lock_expensive_endpoints.md) | Agent 0 done → run Agent 1 |
