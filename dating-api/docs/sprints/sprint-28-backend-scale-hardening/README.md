...
**Status:** 🟡 **IN PROGRESS** — Story 1 Done; Story 2 Agent 1 done → run Agent 2  
...
| 02 | [Lock expensive endpoints](./STORY_02_lock_expensive_endpoints.md) | Agent 1 done → run Agent 2 |
