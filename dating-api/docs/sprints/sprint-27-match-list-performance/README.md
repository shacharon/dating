...
**Status:** 🟡 **IN PROGRESS** — Stories 1–4 Done; Story 5 Agent 2 PASS → run Agent 3  
...
| 05 | [Miss-path observability](./STORY_05_miss_path_observability.md) | Agent 2 PASS → run Agent 3 |
