...
**Status:** 🟡 **IN PROGRESS** — Stories 1–4 Done; Story 5 Agent 1 complete → run Agent 2  
...
| 05 | [Miss-path observability](./STORY_05_miss_path_observability.md) | Agent 1 done → run Agent 2 |
