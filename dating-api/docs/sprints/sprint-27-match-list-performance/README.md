...
**Status:** 🟡 **IN PROGRESS** — Story 1 Done; Story 2 Agent 0 complete → run Agent 1  
...
| 02 | [SQL gender/age prefilter](./STORY_02_sql_gender_age_prefilter.md) | Agent 0 done → run Agent 1 |
