...
**Status:** 🟡 **IN PROGRESS** — Story 1 Agent 0 complete  
...
| # | Story | Status |
|---|-------|--------|
| 01 | [Batch latest evaluations](./STORY_01_batch_latest_evaluations.md) | Agent 0 done → run Agent 1 |
| 02 | [SQL gender/age prefilter](./STORY_02_sql_gender_age_prefilter.md) | PLANNED |
| 03 | [Slim candidate select](./STORY_03_slim_candidate_select.md) | PLANNED |
