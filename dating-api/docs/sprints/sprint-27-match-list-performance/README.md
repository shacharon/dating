...
**Status:** 🟡 **IN PROGRESS** — Stories 1–4 Done; Story 5 Agent 0 complete → run Agent 1  
...
| 05 | [Miss-path observability](./STORY_05_miss_path_observability.md) | Agent 0 done → run Agent 1 |
