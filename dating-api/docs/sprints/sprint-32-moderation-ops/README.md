...
**Status:** 🟡 **IN PROGRESS** — Stories 01–02 Done; Story 03 Agent 1 complete → run Agent 2  
...
| 03 | [Soft / dating policy layer](./STORY_03_soft_policy_layer.md) | P1 | 1d | Agent 1 done → run Agent 2 |
