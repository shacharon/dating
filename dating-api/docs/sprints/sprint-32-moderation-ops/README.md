...
**Status:** 🟡 **IN PROGRESS** — Story 01 Done; Story 02 Agent 0 complete → run Agent 1  
...
| 02 | [Admin blocked-users + full review](./STORY_02_admin_blocked_users.md) | P0 | 1d | Agent 0 done → run Agent 1 |
