...
**Status:** 🟡 **IN PROGRESS** — Story 01 Done; Story 02 Agent 1 complete → run Agent 2  
...
| 02 | [Admin blocked-users + full review](./STORY_02_admin_blocked_users.md) | P0 | 1d | Agent 1 done → run Agent 2 |
