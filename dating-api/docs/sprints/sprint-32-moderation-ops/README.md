...
**Status:** 🟡 **IN PROGRESS** — Stories 01–03 Done; Story 04 Agent 2 CR PASS → run Agent 3  
...
| 04 | [Mute expiry cron + ops polish](./STORY_04_mute_cron_ops.md) | P1 | 0.5d | Agent 2 PASS → run Agent 3 |
