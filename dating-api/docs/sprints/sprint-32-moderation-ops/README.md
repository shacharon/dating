...
**Status:** 🟡 **IN PROGRESS** — Stories 01–02 Done; Story 03 Agent 0 complete → run Agent 1  
...
| 03 | [Soft / dating policy layer](./STORY_03_soft_policy_layer.md) | P1 | 1d | Agent 0 done → run Agent 1 |
