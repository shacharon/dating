...
**Status:** 🟡 **IN PROGRESS** — Stories 1–4 Done; Story 5 Architect locked → Agent 1 Dev  
...
| 05 | [Cutover + deprecate request rebuild](./STORY_05_cutover_deprecate_rebuild.md) | P0 | 0.5–1d | Architect → Agent 1 |
