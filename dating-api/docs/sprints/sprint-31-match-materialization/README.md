...
**Status:** 🟡 **IN PROGRESS** — Story 1 Architect locked → Agent 1 Dev  
...
| # | Story | Priority | Est |
|---|-------|----------|-----|
| 01 | [Materialized rank schema](./STORY_01_materialized_rank_schema.md) | P0 | 0.5–1d | Architect → Agent 1 |
| 02 | [Rebuild job (Bull)](./STORY_02_rebuild_job.md) | P0 | 1–1.5d |
| 03 | [Triggers + invalidation](./STORY_03_triggers_invalidation.md) | P0 | 0.5–1d |
