...
**Status:** 🟡 **IN PROGRESS** — Stories 1–3 Done; Story 4 Dev complete → Agent 2 CR  
...
| 04 | [List reads from materialization](./STORY_04_list_read_path.md) | P0 | 1–1.5d | **Dev done** → Agent 2 CR |
