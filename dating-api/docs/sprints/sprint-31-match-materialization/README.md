...
**Status:** 🟡 **IN PROGRESS** — Stories 1–3 Done; Story 4 Architect locked → Agent 1 Dev  
...
| 04 | [List reads from materialization](./STORY_04_list_read_path.md) | P0 | 1–1.5d | Architect → Agent 1 |
