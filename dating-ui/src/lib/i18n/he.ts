...
export const heCopy: AppCopySchema = {
  ...
  landing: {
    brand: "Dating",
    title: "תכתבו מי אתם. אנחנו נמצא מי שמתאים.",
    subtitle: "בלי שאלון ארוך. בלי החלקות בלי סוף.",
    analysisHint:
      "שלושה טקסטים: אתם, מי שאתם רוצים, ואיזה קשר אתם רוצים. אנחנו קוראים את זה.",
    ...
    termsLink: "תנאים",
    trust: {
      privacy: "מה שכתבתם נשאר פרטי",
      moderation: "השיחות תחת פיקוח",
      compatibility: "התאמה ממה שכתבתם",
    },
    how: {
      title: "איך זה עובד",
      step1Title: "כותבים",
      step1Body: "עליכם, על מי שאתם מחפשים, ועל הקשר שאתם רוצים. במילים שלכם.",
      step2Title: "אנחנו קוראים",
      step2Body: "ההתאמה מחפשת אנשים שרוצים את אותו דבר, לא רק את אותו טווח גיל.",
      step3Title: "ואז מדברים",
      step3Body: "אם זה הדדי, כותבים. השיחות מפוקחות.",
    },
    benefits: {
      title: "למה כאן",
      depthTitle: "מילים, לא שאלון",
      depthBody: "ההתאמה באה ממה שכתבתם, לא מחמישים תפריטים.",
      signalsTitle: "רואים למה",
      signalsBody: "מראים מה התאים. לא פיד מסתורי.",
      safetyTitle: "לא ג׳ונגל",
      safetyBody: "אפשר לדווח. אנחנו בודקים.",
    },
    closing: {
      title: "תורכם",
      subtitle: "מתחברים עם Google וכותבים את שלושת הטקסטים.",
      cta: "חזרה להתחברות",
    },
  },
  languageSettings: {
  ...
  matches: {
    list: {
      ...
      noProfileGate: {
        title: "סיימו את הפרופיל כדי לראות התאמות",
  ...
  onboarding: {
    ...
    textsForm: {
      intro:
        "כמה פסקאות קצרות עוזרות לנו להבין אותך. אפשר לשמור ולחזור, או להמשיך בלי לכתוב עדיין.",
      aboutMeLabel: "עליי",
      aboutMePlaceholder:
        "למשל: אני בגיל 29, אוהב/ת בוקר שקט, ואומר/ת מה שאני מרגיש/ה.",
      aboutPartnerLabel: "על הפרטנר/ית",
      aboutPartnerPlaceholder:
        "למשל: אדם חם, סקרן, ובסדר עם ערב בבית.",
      aboutRelationshipLabel: "על מערכת היחסים",
      aboutRelationshipPlaceholder:
        "למשל: קשר יציב. בודקים אחד את השנייה. בלי משחקים.",
  ...
  profile: {
    ...
    hub: {
      ...
      overviewFraming: "כך אתם נראים לאחרים",
      analyzeNeedTitle: "הניתוח הוא איך אנחנו מוצאים אנשים שמתאימים",
      analyzeNeedBody:
        "כתבו את הסיפור והוסיפו מי אתם, את מי אתם מחפשים, איפה אתם, ותאריך לידה. אחר כך אפשר להריץ.",
      analyzeReadyTitle: "הפרופיל מוכן",
      analyzeReadyBody: "זה קורא את הסיפור ומחפש אנשים שמתאימים.",
      analyzeButton: "נתח את הפרופיל",
      analyzeRunning: "קורא את הפרופיל…",
      analyzeResultTitle: "הניתוח שלך",
      analyzeFailed: "הניתוח לא הסתיים. נסו שוב.",
      overviewPhotoEmptyTitle: "הוסיפו תמונה כדי שאחרים יראו אתכם",
      overviewPhotoEmptyCta: "הוספת תמונה",
      overviewStoryEmptyTitle: "הסיפור שלכם הוא איך אנשים פוגשים אתכם",
      overviewStoryEmptyCta: "כתיבת הסיפור",
      overviewNameEmpty: "הוסיפו כינוי",
      overviewStripStory: "סיפור",
      overviewStripPhotos: "תמונות",
      overviewStripMatching: "התאמה",
      overviewStripAnalysis: "ניתוח",
      overviewStripWords: "{count} מילים",
      overviewStripAnalyzed: "נותח",
      overviewStripNotAnalyzed: "עדיין לא נותח",
      overviewStripPhotosCount: "{filled}/{max} תמונות",
      overviewStripPhotosNone: "אין תמונות עדיין",
      overviewStripPhotosPending: "בבדיקה",
      overviewStripPhotosApproved: "נראה טוב",
