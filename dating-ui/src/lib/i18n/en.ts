...
export const enCopy: AppCopySchema = {
  ...
  profile: {
    ...
    hub: {
      ...
      overviewStoryEmptyCta: "Write your story",
      overviewNameEmpty: "Add a nickname",
      overviewStripStory: "Story",
      overviewStripPhotos: "Photos",
      overviewStripMatching: "Matching",
      overviewStripAnalysis: "Analysis",
      overviewStripWords: "{count} words",
      overviewStripAnalyzed: "Analyzed",
      overviewStripNotAnalyzed: "Not analyzed yet",
      overviewStripPhotosCount: "{filled}/{max} photos",
      overviewStripPhotosNone: "No photos yet",
      overviewStripPhotosPending: "In review",
      overviewStripPhotosApproved: "Looking good",
      ...
      settingsMatchPrefsBody:
        "Choose who you want to see and dealbreakers.",
