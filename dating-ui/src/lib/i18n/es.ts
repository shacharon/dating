...
export const esCopy: AppCopySchema = {
  ...
  profile: {
    ...
    hub: {
      ...
      overviewStoryEmptyCta: "Escribe tu historia",
      overviewNameEmpty: "Añade un apodo",
      overviewStripStory: "Historia",
      overviewStripPhotos: "Fotos",
      overviewStripMatching: "Matching",
      overviewStripAnalysis: "Análisis",
      overviewStripWords: "{count} palabras",
      overviewStripAnalyzed: "Analizado",
      overviewStripNotAnalyzed: "Aún no analizado",
      overviewStripPhotosCount: "{filled}/{max} fotos",
      overviewStripPhotosNone: "Sin fotos aún",
      overviewStripPhotosPending: "En revisión",
      overviewStripPhotosApproved: "Se ve bien",
