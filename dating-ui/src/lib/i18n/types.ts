...
export type AppCopySchema = {
  ...
  profile: {
    ...
    hub: {
      ...
      overviewStoryEmptyCta: string;
      overviewNameEmpty: string;
      overviewStripStory: string;
      overviewStripPhotos: string;
      overviewStripMatching: string;
      overviewStripAnalysis: string;
      overviewStripWords: string;
      overviewStripAnalyzed: string;
      overviewStripNotAnalyzed: string;
      overviewStripPhotosCount: string;
      overviewStripPhotosNone: string;
      overviewStripPhotosPending: string;
      overviewStripPhotosApproved: string;
