import type { MeProfileDto, MeProfileGender, PatchMeProfileBody } from '@/lib/api/me-profile-api';
import { ME_PARTNER_GENDER_CHOICES } from '@/lib/api/me-profile-api';
import { validatePartnerGendersNonEmpty } from '@/lib/profile/profile-field-validation';
