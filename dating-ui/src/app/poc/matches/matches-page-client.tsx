...
import { MatchExplainabilitySection } from '../../dating/matches/match-explainability-section';
import type { MatchExplainabilityDto } from '../../dating/_lib/types';
                    ...
                    {sortedMatchesList.map((m) => (
                      ...
                      >
                        <td className="p-2 text-zinc-600 dark:text-zinc-400">
                          ...
                          {(m.explainability?.reasonShort ?? m.shortReason) != null &&
                            (m.explainability?.reasonShort ?? m.shortReason) !== '' && (
                              <p
                                className="mt-1 max-w-[14rem] text-xs leading-snug text-zinc-500 dark:text-zinc-400 line-clamp-2"
                                title={m.explainability?.reasonShort ?? m.shortReason}
                                data-testid="poc-match-list-explainability"
                              >
                                {m.explainability?.reasonShort ?? m.shortReason}
                              </p>
                            )}
              ...
              <>
                ...
                {result && (
                  <div className="space-y-4">
                    ...
                    {result.status !== 'NOT_ANALYZED' && result.explainability != null && (
                      <div
                        className="rounded border border-zinc-200 bg-white p-4 dark:border-zinc-700 dark:bg-zinc-900"
                        data-testid="poc-match-detail-explainability"
                      >
                        <h2 className="mb-3 text-lg font-semibold text-zinc-900 dark:text-zinc-100">
                          Explainability
                        </h2>
