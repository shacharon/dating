    ...
    <div className="min-h-screen bg-zinc-50 p-6 font-sans dark:bg-zinc-950">
      <div className="mx-auto max-w-xl pt-16 text-center">
        ...
        <Link
          ...
          className="mt-8 inline-block rounded bg-zinc-900 px-6 py-3 font-medium text-white transition-opacity hover:opacity-90 dark:bg-zinc-100 dark:text-zinc-900"
        >
          Get started
        </Link>
      </div>
